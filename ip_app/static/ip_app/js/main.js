// main.js - Enhanced for better IP detection

document.addEventListener('DOMContentLoaded', function() {
    // Initialize any global functions or UI elements
    initToasts();
    setupMobileMenu();
    
    // Debounced lookup function to prevent excessive API calls
...
// Fetch user's IP using external service as a backup
...
function updateIPDetails(data) {
    // Update IP type badge if it exists
...
function showToast(message, type = 'info') {
    ...
    toast.innerHTML = `
        ...
        <span>${message}</span>
        <button class="ml-auto text-white focus:outline-none" aria-label="Close notification">
...
function setupMobileMenu() {
    ...
    if (menuButton && mobileMenu) {
        menuButton.addEventListener('click', function() {
            ...
            // Toggle icon
            const icon = menuButton// main.js - Enhanced for better IP detection
